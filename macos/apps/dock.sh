...
defaults write com.apple.dock minimize-to-application -bool true icons
# "Do not automatically rearrange spaces based on 
defaults write com.apple.dock mru-spaces -bool falsemost recent use
# "Wipe all app icons"
